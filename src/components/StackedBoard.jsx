...
// centred in the SVG. PAD_TOP reserves the same room upward, since stacks only
// grow up — the bottom only needs a small fixed margin, not a matching reserve.
...
const SVG_H = PAD_TOP  + BOARD_SIZE * STEP + PAD;
